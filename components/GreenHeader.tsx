...
export default function Header() {
  return (
    ...
    <header className='w-full max-w-5xl md:max-w-full'>
        <div className={`${Montserratfont.className} hidden  first-header bg-[#23856D] text-white w-full xl:flex items-center justify-between px-7 py-4 `} style={{ fontWeight: 700 }}>
